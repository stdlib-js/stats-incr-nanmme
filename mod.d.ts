...
* ## Notes
*
* -   If either `x` or `y` is `NaN`, the pair is ignored and the accumulator returns the previously accumulated value.
*
* @param x - input value
* @param y - input value
...
/**
* Returns an accumulator function which incrementally computes a moving mean error (ME), ignoring `NaN` values.
*
* ## Notes
*
